...
step2:	and	t1_r, y_r, 0x33333333					//Performs operations of step 2
	lsl	t1_r, t1_r, 2
	lsr	t2_r, y_r, 2
...
step4:	lsl	t1_r, y_r, 24
	...
	lsr	t4_r, y_r, 24
	orr	y_r, t1_r, t2_r						//uses orr multiple times to do y_r | t1 | t2 |t3 | t
	orr	y_r, y_r, t3_r
	orr	y_r, y_r, t4_r
...
exit:	ldp	x29, x30, [sp, 16]					//Unloads the stack pointer and returns for the program to run
	ret
