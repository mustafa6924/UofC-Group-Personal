...
main:
	...
	add	x19, fp, box_s				//Calculates the base address of box 1
	add	x20, fp, box2_s				//Calculates the base address of box 2

	mov	x0, x19					//Move the address of box 1 into the argument
	bl	newBox						//Call newBox(), also saves the result in b
	mov	x19, x0					//Moves the created box into x19

	mov	x0, x20					//Move the address of box2 into the agrument
	bl	newBox						//Call the newBox() function
	mov	x20, x0					//Moves the created box into x20
	...
	mov	x1, x19					//Moves box1 base address into argument 2
	adrp	x0, s_first					//Moves "first" into first argument
	add	x0, x0, :lo12:s_first
	bl	printBox

	mov	x1, x20					//Moves box2 base address into argument 2
	adrp	x0, s_second					//Moves "second" into argument 1
	add	x0, x0, :lo12:s_second
	bl	printBox

	//Using equal method/function
	mov	x0, x19					//Setting up first argument
	mov	x1, x20					//Setting up second argument
	...
	//Using move() function
	mov	x0, x19					//Moves base address of box1 into x0 for first argument
	...
	mov	x0, x20					//Moves address of box into first argument
...
equal:
	...
	mov	x10, x0						//Stores the address of b1 into x21
	mov	x11, x1						//Stores the address of b2 in x23
